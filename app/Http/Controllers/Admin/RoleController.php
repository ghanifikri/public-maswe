...
class RoleController extends Controller
{
    ...
    {
        return view('admin.permissionPage.role.index', [
            'roles' => Role::all()
        ]);
    }
    ...
    {
        return view('admin.permissionPage.role.create', [
    ...
    public function show($id)
    {
        ...
        return view('admin.permissionPage.role.detail', [
            'role' => $role,
            'authorities' => config('permission.authorities'),
    ...
    {
        $role = Role::findOrFail($id);
        return view('admin.permissionPage.role.edit',[
            'role' => $role,
            'authorities' => config('permission.authorities'),
