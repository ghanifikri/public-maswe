    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li class="dropdown"><a class="{{ Request::is('AboutUs*') ? 'active' : '' }}" href="#"><span>About
                ...
                <li><a class="nav-link {{ Request::is('produk*') ? 'active' : '' }}"
                        href="{{ route('produk') }}">Product</a></li>
                <li><a class="nav-link {{ Request::is('gallery*') ? 'active' : '' }}"
                        href="{{ route('gallery') }}">Gallery</a></li>
                <li><a class="nav-link {{ Request::is('news*') ? 'active' : '' }}" href="{{ route('news') }}">News</a>
                </li>
                <li><a class="nav-link {{ Request::is('kontak*') ? 'active' : '' }}"
