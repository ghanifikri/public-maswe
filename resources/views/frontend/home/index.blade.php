...
<section id="recent-blog-posts" class="recent-blog-posts">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="post-box">
                    <div class="post-img"><img src="{{ asset('frontend/img/values-1.png') }}" class="img-fluid" alt="">
                    </div>
            ...
            <div class="col-lg-4">
                <div class="post-box">
                    <div class="post-img"><img src="{{ asset('frontend/img/values-2.png') }}" class="img-fluid" alt="">
                    </div>
            ...
            <div class="col-lg-4">
                <div class="post-box">
                    <div class="post-img"><img src="{{ asset('frontend/img/values-3.png') }}" class="img-fluid" alt="">
                    </div>
...
<section id="banner" class="d-flex flex-column justify-content-center" style=" background: url('{{ asset($aboutKaligandu->background) }}') top center; background-size:cover;background-position:center">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-8">
