        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    <input type="hidden" id="name_values" name="name_values" value="titleHeaderValues">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values1" name="name_values" value="titleHeaderDescription">
            ...
            <div class="card-footer">
                <a href="{{ route('headerPeople.index') }}" class="btn btn-info float-right">Back</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('.btn-title').click(function () {
        ...
        $.ajax({
            url: '{{ route('changeFont.storeTitleHeaderValuess') }}',
            type: 'POST',
            data: {
