...
@section('title', 'Add Data Research')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Tambah Data Research</h1>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('dataResearch.store') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="nama_research">Nama Research</label>
                        <input value="{{ old('nama_research') }}" type="text" class="form-control {{$errors->first('nama_research')
