...
@section('title', 'Section Hero Research')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Create Section Hero Research</h1>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('heroResearch.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_section" value="research">
                    <input type="hidden" name="route" value="research">
