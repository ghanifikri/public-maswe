...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('headerTeam.update', $headerSection->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="id_section" value="fieldTeam">
                    ...
                    <div class="float-right">
                        <a href="{{ route('headerTeam.index') }}" class="btn btn-outline-info px-4 mr-2">Back</a>
