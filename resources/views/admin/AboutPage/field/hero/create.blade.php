...
@section('title', 'Section Hero Field')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Create Section Hero Field</h1>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('heroField.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_section" value="field">
                    <input type="hidden" name="route" value="field">
