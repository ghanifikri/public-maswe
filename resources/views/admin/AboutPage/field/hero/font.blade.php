        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    <input type="hidden" id="name_values" name="name_values" value="titleHeroField">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values2" name="name_values" value="titleHeroFieldLink">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values1" name="name_values" value="subTitleField">
            ...
            <div class="card-footer">
                <a href="{{ route('heroField.index') }}" class="btn btn-info float-right">Back</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('.btn-title').click(function () {
        ...
        $.ajax({
            url: '{{ route('changeFont.storeTitleHeroField') }}',
            type: 'POST',
            data: {
