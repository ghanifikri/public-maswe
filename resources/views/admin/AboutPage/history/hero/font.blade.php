        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    <input type="hidden" id="name_values" name="name_values" value="titleHeroAboutPage">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values2" name="name_values" value="titleHeroAboutPageLink">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values1" name="name_values" value="subTitleHeroAboutPage">
            ...
            <div class="card-footer">
                <a href="{{ route('heroHistory.index') }}" class="btn btn-info float-right">Back</a>
            </div>
        </div>
    </div>
</div>
