...
@section('content')
<h1 class="h3 mb-4 text-gray-800">Add History</h1>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('longHistory.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control {{$errors->first('description')
                            ? "is-invalid": ""}}" id="input_post_content">{{old('description')}}</textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="image_label" name="image" value="{{ old('image') }}" type="text" class="form-control {{$errors->first('image') ? "is-invalid": ""}}" placeholder="" readonly />
                            <div class="invalid-feedback">
                                {{$errors->first('image')}}
                            </div>
                        </div>
