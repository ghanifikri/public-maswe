        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    <input type="hidden" id="name_values" name="name_values" value="titleLongHistories">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values1" name="name_values" value="titleDescription">
            ...
            <div class="card-footer">
                <a href="{{ route('longHistory.index') }}" class="btn btn-info float-right">Back</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('.btn-title').click(function () {
        ...
        $.ajax({
            url: '{{ route('changeFont.storeTitleLongHistories') }}',
            type: 'POST',
            data: {
