...
@section('title', 'create hero Contact')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Create hero Contact</h1>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('messageHero.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
