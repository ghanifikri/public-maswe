...
@section('title', 'create title Product')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Create Title Product</h1>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('productHero.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
