...
@section('title', 'create title section news')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Create Title Section News</h1>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('title.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
