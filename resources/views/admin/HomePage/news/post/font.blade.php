        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    <input type="hidden" id="name_values" name="name_values" value="titlePost">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values1" name="name_values" value="subTitlePost">
            ...
            <div class="card-footer">
                <a href="{{ route('post.index') }}" class="btn btn-info float-right">Back</a>
            </div>
        </div>
    </div>
</div>
