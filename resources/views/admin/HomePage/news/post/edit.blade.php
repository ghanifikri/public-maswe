                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="image_label" name="thumbnail" value="{{ old('thumbnail',asset($post->thumbnail)) }}" type="text" class="form-control {{$errors->first('thumbnail') ? "is-invalid": ""}}" placeholder="" readonly />
                                    <div class="invalid-feedback">
