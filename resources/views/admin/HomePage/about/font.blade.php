        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    <input type="hidden" id="name_values" name="name_values" value="titleAbout">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values1" name="name_values" value="subTitleAbout">
            ...
            <div class="card-footer">
                <a href="{{ route('about.index') }}" class="btn btn-info float-right">Back</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('.btn-title').click(function () {
        ...
        $.ajax({
            url: '{{ route('changeFont.storeAbout') }}',
            type: 'POST',
            data: {
