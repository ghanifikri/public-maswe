        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    <input type="hidden" id="name_values" name="name_values" value="titleHeaderVideo">
                ...
                <div class="form-group row">
                    <input type="hidden" id="name_values1" name="name_values" value="subTitleHeaderVideo">
            ...
            <div class="card-footer">
                <a href="{{ route('header-video.index') }}" class="btn btn-info float-right">Back</a>
            </div>
        </div>
    </div>
</div>
